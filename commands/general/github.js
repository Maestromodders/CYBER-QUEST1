...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/mruniquehacker/CYBER_QUEST-Mini';
            const apiUrl = 'https://api.github.com/repos/mruniquehacker/CYBER_QUEST-Mini';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* CYBER_QUEST-Mini\n`;
